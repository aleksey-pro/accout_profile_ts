    ...
    return (
        <div className="create_product__category">
            ...
            <div className="price_items">
                <Text title={t('Enter the price of the product *')} id={'price'} name={'price'} placeholder={'0 грн'} required={true} />
                <Text title={t('How much did you buy the product for?')} id={'bought_price'} name={'bought_price'} placeholder={'0 грн'} required={true} />
            </div>
            <Textarea title={t('Additional condition of sale')} id={'additional_condition'} name={'additional_condition'}
                      required={true} placeholder={t('For example, I will send only after subscription')}/>
            <div className="checkbox_items">
                <Checkbox title={t('Bargaining is possible')} id={'bargain'} name={'bargain'} />
                <Checkbox title={t('Barter is possible')} id={'barter'} name={'barter'} />
